...
class VerifyOtp extends StatefulWidget {
  ...
  VerifyOtp({Key key, this.usrName, this.mobNum,this.strDetail}) : super(key: key);
  @override
  _ForgotPasswordStatee createState() => _ForgotPasswordStatee();
}

class _ForgotPasswordStatee extends State<VerifyOtp> {
                  ...
                  InkWell(
                    ...
                    onTap: () async {
                      if(otpController.text.toString().isNotEmpty &&  pwdController.text.toString().isNotEmpty){
                        var rsp = await regOtp(
                            widget.usrName.toString(), pwdController.text.toString(), otpController.text.toString(),widget.strDetail.toString(), widget.mobNum.toString());
