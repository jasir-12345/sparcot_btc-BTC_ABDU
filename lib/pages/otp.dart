...
import 'package:sparcotbtc/Api/SendOtpApi.dart';
...
import 'package:sparcotbtc/pages/verify_otpreg.dart';
...
class _ForgotPasswordState extends State<OTP> {
              ...
              children: <Widget>[
                ...
                FadeIn(
                  ...
                  InkWell(
                    ...
                    onTap: () async {
                      if(passController.text.toString().isNotEmpty && mobileController.text.toString().isNotEmpty){
                        var usrname = passController.text.toString();
                        var mob = mobileController.text.toString();
                        var rsp = await sendOtp(usrname,mob);
